 ...
 */
function buildWMSTileUrl(layers: string, x: number, y: number, zoom: number, tileSize: number = 512): string {
...
export async function downloadChartLayer(
  ...
  const tileSize = 512; // 512px tiles for better quality (4x more pixels than 256px)
