...
export const CHART_LAYERS = {
  ...
  REA: {
    url: 'https://geoaisweb.decea.mil.br/geoserver/wms',
    // NOTE: ICA:CCV_REA_WB_BELEM está com erro no GeoServer (ServiceException ao ler o GeoTIFF).
    // Se incluirmos essa subcamada, o GeoServer falha o GetMap inteiro e a REA não renderiza.
