 ...
 * 
 * ZOOM LEVELS EXPANDED (v3):
 * - Increased to 5-10 for aeronautical charts to ensure readable text and symbols
 * - Pilots need to see small letters and symbols at high zoom levels
 * - Download time increases but legibility is critical for flight safety
 */
...
export const CHART_LAYERS = {
  HIGH: {
    ...
    zoomLevels: [5, 6, 7, 8, 9, 10]  // Expanded for legibility
  },
  LOW: {
    url: 'https://geoaisweb.decea.mil.br/geoserver/wms',
  ...
  REA: {
    ...
    zoomLevels: [6, 7, 8, 9, 10]  // Expanded for legibility
  },
  REUL: {
    url: 'https://geoaisweb.decea.mil.br/geoserver/wms',
    layers: 'ICA:CCV_REUL_WJ3_RIO_DE_JANEIRO',
    zoomLevels: [7, 8, 9, 10]  // Expanded for legibility
  },
  REH: {
    url: 'https://geoaisweb.decea.mil.br/geoserver/wms',
...
// Expanded zoom levels for better detail
