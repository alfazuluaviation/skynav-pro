...
// OPTIMIZED: Reduced zoom levels to minimize download time
// Zoom 5-8 = ~600 tiles (vs 10000+ with zoom 5-10)
// Users can still view online at any zoom, but offline is limited
export const CHART_LAYERS = {
  HIGH: {
    ...
    zoomLevels: [5, 6, 7, 8]  // Reduced from [5-10] to [5-8]
  },
  LOW: {
    url: 'https://geoaisweb.decea.mil.br/geoserver/wms',
  ...
  REA: {
    ...
    zoomLevels: [6, 7, 8]  // Reduced from [6-10] to [6-8]
  },
  REUL: {
    url: 'https://geoaisweb.decea.mil.br/geoserver/wms',
    layers: 'ICA:CCV_REUL_WJ3_RIO_DE_JANEIRO',
    zoomLevels: [7, 8]  // Reduced from [7-10] to [7-8]
  },
  REH: {
    url: 'https://geoaisweb.decea.mil.br/geoserver/wms',
...
// OPTIMIZED: Reduced zoom levels for faster download
export const BASE_MAP_LAYERS = {
  OSM: {
    url: 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',
    subdomains: ['a', 'b', 'c'],
    zoomLevels: [4, 5, 6, 7, 8],  // Reduced from [4-10]
    label: 'OpenStreetMap'
  },
  DARK: {
