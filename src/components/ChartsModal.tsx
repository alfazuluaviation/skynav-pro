...
export const ChartsModal: React.FC<ChartsModalProps> = ({ isOpen, onClose, initialIcao }) => {
  ...
  return (
    <div className="fixed inset-0 z-[3000] flex items-center justify-center">
      ...
      {/* Modal */}
      <div className={`relative w-full ${isMaximized ? 'max-w-[95vw] h-[95vh]' : 'max-w-2xl max-h-[85vh]'} bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl overflow-hidden mx-4 transition-all duration-300 flex flex-col`}>
        {/* Header */}
